...
builtQuery=('https://www.ebi.ac.uk/europepmc/webservices/rest/search?query=%28AFF%3A%22University%20of%20Virginia%22%29%20AND%20%28FIRST_PDATE%3A%5B2017-01-01%20TO%202020-12-31%5D%29%20AND%20%28HAS_FT%3AY%29&resultType=core&cursorMark=*&pageSize=1000&format=xml') #updated query with page count = 1000, Pub Year = 2017-2020, and UVA as AFF
...
df = pd.DataFrame({'Authors':authors,'Article_Title':title,'Journal_Title':iso,'date':date,'DOI':doi,'Open_Access': openAccess})
